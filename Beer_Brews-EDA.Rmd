...
```
ABV Comparison by State - USMap

```{r, echo=FALSE, message = FALSE, warning=FALSE}
us_map <- usmap::us_map() # used to add map scale

usmap::plot_usmap(data = abv, values = "med_abv", labels = T) +
  labs(fill = 'Median ABV by State') + 
  scale_fill_gradientn(colours=rev(terrain.colors(50)),na.value="grey90",
                       guide = guide_colourbar(barwidth = 25, barheight = 0.6,
#put legend title on top of legend
title.position = "top")) +
...
IBU Comparison by State - Bar Chart
...
IBU Comparison by State - USMap

```{r, echo=FALSE, message = FALSE, warning=FALSE}
#USMap
usmap::plot_usmap(data = ibu, values = "med_ibu", labels = T)+
  labs(fill = 'Median IBU by State') + 
  scale_fill_gradientn(colours=rev(terrain.colors(50)),na.value="grey90",
                       guide = guide_colourbar(barwidth = 25, barheight = 0.6,
#put legend title on top of legend
