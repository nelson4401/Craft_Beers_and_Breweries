...
sub_data = sub_data %>% mutate(Alcohol_by_Volume = scale(ABV),biterness_scale = scale(IBU))

sub_data %>% ggplot(mapping = aes(x=Alcohol_by_Volume,y=biterness_scale,color=IPA)) + geom_point(position = 'jitter')
